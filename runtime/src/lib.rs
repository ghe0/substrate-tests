...
// pub use pallet_aura::Authorities;
...
parameter_types! {
	pub const PotId: PalletIdStruct = PalletIdStruct(*b"PotStake");
	pub const SessionLength: BlockNumber = 6 * HOURS;
	// StakingAdmin pluralistic body.
	pub const StakingAdminBodyId: BodyId = BodyId::Defense;

	// 5EYCAe5ijiYfyeZ2JJCGq56LmPyNRAKzpG4QkoQkkQNB5e6Z;
	// treasury account of node-staker pallet
...
construct_runtime!(
	pub struct Runtime {
		...
		// Governance
		Sudo: pallet_sudo = 15,
		SudoAuthorities: pallet_sudo_authorities = 16,
		...
		NodeStaker: pallet_node_staker = 50,
		UserManager: pallet_user_manager = 51,
	}
);
